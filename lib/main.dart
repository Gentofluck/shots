...
class _MyAppState extends State<MyApp> with WindowListener {
  ...
  final GlobalKey<ScreenshotEditorState> editorKey =
      GlobalKey<ScreenshotEditorState>();
  ...
  Future<void> _handleHotKeyRegister(HotKey hotKey) async {
    await hotKeyManager.register(hotKey, keyDownHandler: _keyDownHandler);
    setState(() {
  ...
  Future<void> _handleHotKeyRegisterSend(HotKey hotKey) async {
    await hotKeyManager.register(hotKey, keyDownHandler: _keyDownHandlerSend);
    setState(() {
      _registeredHotKeyList = [...hotKeyManager.registeredHotKeyList];
    });
  ...
  Widget _buildCurrentPage() {
    switch (pageName) {
      case 'authPage':
        return AuthPage(changePage: _changePage, shotsClient: shotsClient);
      case 'settingsPage':
        return HomePage(
